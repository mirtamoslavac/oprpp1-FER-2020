...
/**
 * The {@code ShellCommand} interface that represents a model for various commands within the {@link MyShell}.
 *
...
public interface ShellCommand {
     ...
     * @throws NullPointerException when the given {@code env} or {@code arguments} is {@code null}.
